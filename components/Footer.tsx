      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-3 flex flex-col items-start gap-5">
            ...
            <p className="text-gray-500 text-xs leading-relaxed max-w-[220px]">
              Curating the world&apos;s finest automotive acquisitions since 2026.
            </p>
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            ...
            <p className="text-gray-500 text-xs leading-relaxed">
              Be the first to receive new arrivals, private collection drops, and exclusive invitations.
            </p>
            <form
            ...
            >
              ...
              <p className={`text-[10px] mt-2 tracking-wide transition-colors duration-300 ${
                status === "success" ? "text-[#00ff87]" : status === "error" ? "text-red-400" : "text-gray-600"
              }`}>
                {status === "success"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.2em] text-gray-600">
            ...
            <span className="text-white/[0.08]">/</span>
            <Link href="/cookies" className="hover:text-gray-400 transition-colors duration-200">
              Cookies
            </Link>
          </div>
