	...
	const handleAllocation = () => {
		if (isAllocated) {
			...
			addToAllocation({
				...
				color: selectedColor,
				image: getValidImageSrc(car.image),
				badge: car.badge,
				...
				<section className="mb-24 sm:mb-32">
					...
					<div className="relative grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
						...
						<div className="lg:col-span-7">
							<div
								className="group relative mb-5 aspect-[16/10] overflow-hidden rounded-2xl border border-[#e5efe3]/10 bg-[#091a11] shadow-[0_30px_70px_-42px_rgba(0,0,0,0.85)] cursor-zoom-in"
								onClick={() => setIsLightboxOpen(true)}>
								<div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-t from-[#050e0a]/25 to-transparent opacity-80" />

								{/* Expand Indicator */}
								<div className="absolute top-2 right-14 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer">
									<div className="bg-[#091a11]/60 backdrop-blur-md p-2.5 rounded-full border border-[#e5efe3]/10 text-[#e5efe3]/80 hover:text-[#00ff87] hover:scale-110 transition-all shadow-lg">
										<Maximize size={20} />
									</div>
								</div>
