      ...
      >
        ...
        {ventAngles.map((deg) => (
          <g key={deg} transform={`rotate(${deg} 50 50)`}>
            <path
              d="M 47.6 5.5 L 50 2.7 L 52.4 5.5 L 51.2 14 L 48.8 14 Z"
              fill="#080a08"
              opacity="0.9"
            />
          </g>
        ...
        {fiveLugAngles.map((deg) => (
          <g key={deg} transform={`rotate(${deg} 50 50)`}>
            <path
              d="M 50 10 L 44.5 17 L 42.2 41 L 48.7 38 L 50 23 Z"
              fill="url(#logoMachinedFace)"
            />
            <path
              d="M 50 10 L 50 23 L 51.3 38 L 57.8 41 L 55.5 17 Z"
              fill="url(#logoSpokeShadow)"
            />
            <path
              d="M 43.4 41 L 35 61 L 43 58 L 49 39 Z"
              fill="#111611"
              opacity="0.88"
            />
            <path
              d="M 56.6 41 L 65 61 L 57 58 L 51 39 Z"
              fill="#29312b"
              opacity="0.9"
            />
            <path
              d="M 44.5 17 L 50 10 L 55.5 17 L 50 24 Z"
              fill="#111611"
              stroke="#566158"
              strokeWidth="0.45"
            />
