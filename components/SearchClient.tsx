			...
			<div className="max-w-7xl mx-auto flex flex-col gap-12">
				...
				<div className="flex flex-col gap-4 text-center md:text-left">
					...
					<h1
						...
						{searchTerm.trim() ? (
							<>
								Showing results for &quot;
								<span className="text-[#00ff87]">{searchTerm}</span>&quot;
							</>
						) : (
							"Explore Inventory"
						)}
					...
					<p className="text-slate-400 text-sm md:text-base">
						{searchTerm.trim() ? (
							<>
								Found {totalResults} matching results across showroom inventory
								and locations
							</>
						) : (
				...
				<div className="w-full max-w-2xl mx-auto md:mx-0">
					...
					<div className="flex items-center gap-3 mt-4 flex-wrap">
						<span
							className="text-[10px] uppercase tracking-widest text-[#00ff87]/65 font-bold"
							style={{ fontFamily: "Orbitron, sans-serif" }}>
							Suggested:
						</span>
						{popularTags.map((tag) => (
					...
					{totalResults > 0 ? (
													...
													<div className="space-y-3 font-manrope text-sm text-slate-300">
														...
														<div className="flex items-start gap-2.5">
															...
															<div>
																...
																<p className="text-[#00ff87] text-xs font-semibold mt-0.5">
																	{showroom.timing.weekends}
																</p>
															</div>
														</div>
													</div>
						...
						<motion.div
							...
							<p className="text-slate-400 text-sm max-w-md mb-8">
								{searchTerm.trim() ? (
									<>
										We couldn&apos;t find any vehicles or showrooms matching
										&quot;
