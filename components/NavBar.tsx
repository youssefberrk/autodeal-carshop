...
`}
      ...
      >
        ...
        />
        <div
          className={`grid grid-cols-2 md:grid-cols-3 items-center transition-all duration-300 max-w-7xl mx-auto ${
            isScrolled ? "px-4 py-1.5 sm:px-6 sm:py-2" : "px-4 py-3 sm:px-6 sm:py-4"
          }`}
        >
          {/* Logo (Left Column) */}
          ...
          {/* Desktop Links (Center Column - Dead Center) */}
          <div className="hidden md:flex items-center justify-center gap-6 lg:gap-12 xl:gap-16 logo fon uppercase text-slate-300 text-[10px] tracking-[0.2em]">
            {[
              { href: "/", label: "Home" },
          ...
          <div
            className={`flex items-center justify-end transition-all duration-300 relative text-slate-300 ${
              isScrolled ? "gap-3 sm:gap-4 md:gap-5" : "gap-4 sm:gap-5 md:gap-6"
            }`}
          >
            {/* Search */}
            <button
            ...
            >
              <FaSearch
                className={`hover:text-green-400 transition cursor-pointer transition-all duration-300 ${
                  isScrolled
