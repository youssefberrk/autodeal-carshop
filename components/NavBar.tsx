...
`}
				...
				<div
					className={`relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 transition-all duration-300 max-w-7xl mx-auto px-4 sm:px-6 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:gap-6 xl:gap-8 xl:px-8 ${
						isScrolled ? "py-1.5 sm:py-2" : "py-2.5"
					}`}>
					{/* Logo (Far Left) */}
								...
								<AnimatePresence>
									{profileOpen && (
										<motion.div
											...
											style={{
												background:
													"linear-gradient(90deg, rgba(16, 16, 16, 0.96) 0%, rgba(0, 0, 0, 0.98) 50%, rgba(21, 21, 21, 0.96) 100%)",
											}}>
											{session ? (
												<>
													{/* User Header */}
				...
				<AnimatePresence>
					{menuOpen && (
						<motion.div
							...
							style={{
								background:
									"linear-gradient(90deg, rgba(16, 16, 16, 0.97) 0%, rgba(0, 0, 0, 0.99) 50%, rgba(21, 21, 21, 0.97) 100%)",
