			...
			<div className="container relative z-10 mx-auto px-6 py-24 flex flex-col lg:flex-row items-center">
				...
				<div className="w-full lg:w-2/5 flex flex-col gap-8 lg:pl-12">
					<div className="space-y-4">
						<span className="text-primary text-xs font-bold uppercase tracking-[0.4em] opacity-80 animate-in" style={{ animationDelay: '0s' }}>
							Exclusivity Defined
						</span>
					...
					<p className="text-lg lg:text-xl hero-subtitle text-muted-foreground leading-relaxed max-w-md">
						Experience the pinnacle of automotive engineering. Curated luxury and performance, delivered with precision.
					</p>
					<div className="flex hero-buttons gap-4 pt-4">
						<Button size="lg" className="w-[200px] h-[56px] text-lg font-bold rounded-full">
							Explore Collection
						</Button>
						<Button variant="outline" size="lg" className="w-[200px] h-[56px] text-lg font-bold rounded-full border-brand/30 hover:border-brand">
							Contact Us
						</Button>
					</div>
				</div>
