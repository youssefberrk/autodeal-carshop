        ...
        <Body className="bg-bgDark my-auto mx-auto font-sans">
          <Container className="border border-solid border-white/10 rounded-xl my-[40px] mx-auto p-[20px] max-w-[600px] bg-bgCard">
            ...
            <Section className="my-[20px]">
              ...
              <Text className="text-textLight/70 text-[14px] leading-[24px]">
                Congratulations. Your allocation for the following mechanical masterpieces has been officially secured. Our concierge team is currently preparing your build specifications.
              </Text>
            </Section>
            ...
            <Section className="text-center mt-[40px]">
              <Text className="text-textLight/40 text-[11px] leading-[18px] mb-[20px]">
                This email confirms your non-refundable deposit. A concierge will contact you within 24 hours to finalize your bespoke configuration options.
              </Text>
              <Text className="text-textLight text-[10px] font-bold tracking-[0.3em] uppercase">
                AUTO<span className="text-brand">DEAL</span> | THE PEAK OF PERFORMANCE
              </Text>
            </Section>
          </Container>
        </Body>
