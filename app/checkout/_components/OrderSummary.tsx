    ...
    <div className="lg:col-span-5 flex flex-col lg:sticky lg:top-24 lg:self-start space-y-6">
          ...
          return (
            ...
            >
              ...
              <div className="aspect-[16/9] w-full bg-[#030c07] mb-4 overflow-hidden border border-[#dae6d8]/10 group-hover:border-[#00ff87]/30 rounded-xl relative shadow-md">
                ...
                />
                {useMock && index === 0 && (
                  <div className="absolute top-3 left-3 bg-emerald-500/95 text-black text-[9px] uppercase tracking-widest font-bold px-3 py-1 rounded-full shadow-lg backdrop-blur-md">
                    Preview Mode
                  </div>
                )}
              </div>
              ...
              {/* Specs Grid */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 bg-[#030d07]/80 border border-[#dae6d8]/8 rounded-xl p-3.5 mb-4">
                <div>
              ...
              <div className="flex gap-2.5">
                ...
                <button
                  type="button"
                  onClick={() => (useMock ? onExitMock() : onUnlockSlot(car.id))}
      ...
      <div className="bg-[#081d12]/90 backdrop-blur-2xl p-6 border border-[#00ff87]/20 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6),0_0_25px_rgba(0,255,135,0.04)] space-y-4">
        <div className="space-y-2.5 pb-4 border-b border-[#dae6d8]/10 text-xs">
          ...
          <div className="flex justify-between tracking-wide">
            <span className="text-[#dae6d8]/60">Bespoke Custom Configuration</span>
            <span className="font-bold text-[#e5efe3]">${customConfiguration.toLocaleString()}</span>
          </div>
          <div className="flex justify-between tracking-wide">
            <span className="text-[#dae6d8]/60">Global Delivery &amp; Concierge</span>
