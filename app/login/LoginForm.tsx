		...
		<motion.div
			...
			<div>
				<div className="flex justify-between items-center mb-3">
					<label
						...
						style={{
							color: keyFocused ? "#00ff87" : undefined,
							transition: "color 0.2s",
						}}>
						Access Key
					</label>
					<button
						type="button"
						className="text-[9px] uppercase tracking-widest text-[#00ff87]/60 hover:text-[#00ff87] transition-colors font-bold">
						Forgot?
					</button>
				</div>
				<div className="relative">
					...
					<Key
						...
						size={15}
						style={{
							color: keyFocused ? "#00ff87" : "rgba(218,230,216,0.25)",
							transition: "color 0.2s",
						}}
					/>
				</div>
			...
			<div className="pt-4 space-y-4">
				...
				<div className="grid grid-cols-2 gap-3">
					<button
						className="flex items-center justify-center gap-2 py-[13px] text-[9px] uppercase tracking-widest font-bold hover:bg-[#dae6d8]/5 transition-all active:scale-[0.97] duration-200"
