...
export const metadata: Metadata = {
	...
	description:
		"Browse our curated selection of pre-owned luxury, exotic, and performance vehicles — each fully inspected and certified.",
	openGraph: {
...
const assurancePoints = [
	{
		label: "190-point inspection",
		desc: "Every vehicle undergoes a comprehensive mechanical & cosmetic audit.",
	},
	{
		label: "service history",
		desc: "Full provenance documentation and service records verified.",
	},
	{
		label: "extended warranty",
		desc: "Eligible for 12–24 month extended coverage plans.",
	},
	{
		label: "30-day assurance",
		desc: "Drive with confidence — 30-day exchange guarantee included.",
	},
];
			...
			<section className="hero-section">
				...
				<div className="hero-content">
					...
					<p className="hero-subtitle">
						Every pre-owned vehicle in our collection passes a rigorous
						certification process. Nothing less than showroom quality.
					</p>
				</div>
			</section>
			...
			<section className="marketplace-section" style={{ paddingTop: 0 }}>
				<div className="section-header">
					...
					<p className="section-count">
						{preOwnedCars.length} hand-selected vehicles
					</p>
				</div>
			...
			<section className="new-cta-section">
				<div className="new-cta-inner">
					...
					<p className="new-cta-text">
						Looking to part ways with your current drive? Receive a competitive
