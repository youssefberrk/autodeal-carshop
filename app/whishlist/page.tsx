          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#dae6d8]/40 text-xs uppercase tracking-widest mt-1">
                {whishListCars.length} {whishListCars.length === 1 ? 'vehicle' : 'vehicles'} saved for later
              </p>
            </div>
          </div>
        </div>
        ...
        {whishListCars.length > 0 ? (
          ...
          <div className="bg-[#141e16]/50 backdrop-blur-md rounded-2xl p-20 border border-[#dae6d8]/5 text-center">
            ...
            <p className="text-[#dae6d8]/40 text-sm max-w-xs mx-auto mb-8">
              Explore our curated selection of luxury vehicles and save your favorites here.
            </p>
            <Link 
              href="/shop"
